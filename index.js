...
const unfundedStr = `A total of $${totalContributions.toLocaleString('en-US')} was raised for ${totalGames} games. There ${numUnfundedGames === 1 ? 'is' : 'are'} ${numUnfundedGames} game${numUnfundedGames === 1 ? '.' : 's'} that remain unfunded, help fund these amazing games!`;  

// create a new DOM element containing the template string and append it to the description container
const unfundedInfo = document.createElement("p");
unfundedInfo.innerHTML = unfundedStr;
descriptionContainer.append(unfundedInfo);
